		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="our_product.php"><i class="glyphicon glyphicon-record"></i>Our Product</a></li>
                    <li><a href="all_post.php"><i class="glyphicon glyphicon-pencil"></i>Blog Post</a></li>
                    <li><a href="view_mesg.php"><i class="glyphicon glyphicon-tasks"></i>Message</a></li>
                    <li class="submenu">
                         <a href="#">
