...
<html lang="en">
	<head>
        ...
        -->
		<title>Learning Point - Curiasity Zone</title>
	...
	<body id="top">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <p><i class="fa fa-phone"></i><span> Phone</span>+8801816348214</p>
                    </div>
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <p><i class="fa fa-envelope-o"></i><span> Email</span><a href="">jahidul1971@yahoo.com</a></p>
                    </div>
                    <div class="col-md-5 col-sm-4 col-xs-12">
                        <ul class="social-icon">
                            <li><span>Meet us on</span></li>
                            <li><a href="https://www.facebook.com/nobitabright" class="fa fa-facebook"></a></li>
                            <li><a href="#" class="fa fa-twitter"></a></li>
                            <li><a href="#" class="fa fa-instagram"></a></li>
                            <li><a href="https://www.youtube.com/channel/UCe_QRPbvqYfvx75r_QBzmeA" class="fa fa-youtube"></a></li>
                            <?php
                                if(!$username){
		...
		<nav class="navbar navbar-default templatemo-nav" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="#" class="navbar-brand">LEARNING POINT</a>
				</div>
    		...
    		<div class="container">
    			<div class="row">
    				<div class="col-md-offset-2 col-md-8">
    					<h2 class="wow fadeIn" data-wow-offset="50" data-wow-delay="0.9s">We help you for finding you curiosity with<span>Learning Point</span></h2>
    					<div class="element">
                            <div class="sub-element">Hello,This is your Learning Point</div>
                            <div class="sub-element">Something New and Intersting</div>
                            <div class="sub-element">If you think you have a idea,Please contact us.</div>
                        </div>
    	...
    	<!-- start about -->
		<section id="about">
                <?php include 'lear.php'; ?>
		</section>
		<!-- end about -->

    	<!-- start service -->
    	<section id="service">
        <?php include 'think.php'; ?>
    	</section>
    	<!-- end servie -->
    			...
    			<div class="row">
    				...
    				<div class="col-md-6 col-sm-6 col-xs-12 wow fadeInRight" data-wow-offset="50" data-wow-delay="0.6s">
    					<address>
    						...
    						<p><i class="fa fa-phone"></i> +8801816348214</p>
    						<p><i class="fa fa-envelope-o"></i> jahidul1971@yahoo.com</p>
    						<p><i class="fa fa-map-marker"></i> Curiasity Zone-Sonargoan,Narayangonj,Dhaka,Bangladesh</p>
    					</address>
    					<ul class="social-icon">
    						<li><h4>WE ARE SOCIAL</h4></li>
    						<li><a href="https://www.facebook.com/bright.j.hasan" class="fa fa-facebook"></a></li>
    						<li><a href="#" class="fa fa-twitter"></a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        Awesome &copy; Copyright 2016. Designed By Giri Designs and Re-design by Jahidulhasanzahid</p>
                    </div>
                </div>
                <div class="col-md-5 col-sm-4 col-xs-12">
                        <ul class="social-icon">
