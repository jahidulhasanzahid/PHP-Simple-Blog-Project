...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Lifestyle - Curiasity zone</title>
        <!-- Meta -->
                ...
                <div class="container padding-vert-30 margin-top-60">
                    <div class="row">
                        ...
                        <div class="col-md-4 margin-bottom-20">
                            ...
                            <p>
                                <span class="fa-phone">Telephone:</span>+8801816348214
                                <br>
                            ...
                            <p>Curiasity Zone(Awesome Life),
                                <br>Sonargoan,Narayangonj,
                                <br>Dhaka,
                                <br>Bangladesh</p>
                        </div>
                        <!-- End Contact Details -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div id="copyright" class="col-md-4">
                            <p class="pull-right">(c) 2014 Your Copyright Info Curiasity zone</p>
                        </div>
                    </div>
                </div>
            </div>
